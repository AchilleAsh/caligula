...
class infoParser(HTMLParser):
	...
	def __init__(self):
		...
		self.current_row = []
		self.current_data = []
		self.URL0 = 'http://caligula.ensea.fr/ade/standard/gui/interface.jsp?projectId=4&login=%s&password=%s' %(login,login)
		self.s = requests.Session()
...
def search_item(name):
	...
	if len(parser.itemsID)==0: # si aucun résultat n'est trouvé
		...
		print "Le mot de passe entré est peut-être mauvais"
		sys.exit(2)
...
def usage():
	...
	print 'Usage : '
	print 'caligula.py <options> -l <login de caligula.ensea.fr>'
	print ''
	print 'Options:'
	print '-s --search 	partie du nom de prof, groupe de TD ou salle'
	print 'exemple 1 : caligula.py -s guerquin -l login'
	print 'exemple 2 : caligula.py -s C104 -l login'
	print 'exemple 3 : caligula.py -s \'1G1 TP3\' -l login'
	print ''
	print '-g --groupe 	groupe complet avec la syntaxe GxTDxTPx'
	print '			all extraira tous les groupes'
	print 'exemple : caligula.py -g 2G1TD1TP1 -l login'
	print 'exemple : caligula.py -g all -l login'
	print ''
